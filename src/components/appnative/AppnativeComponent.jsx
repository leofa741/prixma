...
export const AppnativeComponent = () => {
  return (
    <>
    <Header
    title="App Native"
            ...
            <div className="row g-5">
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="d-flex align-items-center mb-5">
                        ...
                        <h3 className="lh-base mb-0">App-delivery </h3>
                        <h3 className="lh-base mb-0">App-Restaurantes</h3>
                    </div>
                    <p className="mb-4">
                ...
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div className="d-flex align-items-center mb-3">
                        ...
                        <h2 className="text-primary fw-bold mb-0" data-toggle="counter-up">$ 55.000</h2>
                    </div>
                    ...
                    <div className="d-flex align-items-center mb-3">
                        ...
                        <h2 className="text-primary fw-bold mb-0" data-toggle="counter-up">$ 5.500</h2>
                    </div>
