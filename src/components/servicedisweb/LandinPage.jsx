        ...
        <div className="container">
            <div className="row g-5">
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p className="mb-3"><i className="far fa-check-circle text-primary me-3"></i>Web económica</p>
                    ...
                    href="https://wa.me/+5491136038167?text=Hola%20me%20gustaria%20saber%20mas%20sobre%20la%20landing%20page"
                ...
                <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div className="d-flex align-items-center mb-3">
                        ...
                        <h2 className="text-primary fw-bold mb-0" data-toggle="counter-up">$ 21.000</h2>
                    </div>
